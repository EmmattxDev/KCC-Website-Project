        ...
        {menuItems.map((menu, index) => {
          ...
          return (
            ...
            <li key={index} className='relative list-none px-3 md:my-0 my-7'>
              <NavLink to={menu.url} reloadDocument
              // style={({isActive}) =>{
              //   return isActive ? { color:"red"} : {}
              // }} 
              className='flex md:flex-row md:justify-center md:items-center text-slate-700 hover:text-blue-600 md:text-base text-xl md:font-semibold transition duration-300 ease-in-out cursor-pointer'>
