...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white py-4 px-10 flex flex-row flex-grow flex-shrink-0 lg:justify-start md:justify-between items-center m-auto w-full sticky top-0 z-10 border-b-2 border-slate-400 border-opacity-40">
      <div className="mr-16">
        <Link to='/'>
          ...
          {menuItems.map((menu, index) => {
            ...
            return (
              ...
              <li key={index} className='relative list-none px-3'>
                <Link to={menu.url} className='flex flex-row justify-center items-center text-slate-700 hover:text-blue-600 text-base font-semibold transition duration-300 ease-in-out cursor-pointer'>
